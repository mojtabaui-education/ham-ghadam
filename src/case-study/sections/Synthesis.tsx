...
function ThemeBar({ sources, text }: { sources: number; text: string }) {
  ...
  return (
    <div className="flex w-full items-center gap-4">
      <p className="min-w-0 flex-1 text-start text-[clamp(14px,0.83vw,16px)] leading-[1.7] text-ink">
        {text}
      </p>
  ...
  return (
    <Section id="synthesis" gap={40}>
      ...
      <div className="grid w-full grid-cols-1 gap-[clamp(12px,1vw,20px)] lg:grid-cols-[1fr_544px]">
        <div className="flex flex-col items-start gap-[18px] rounded-card bg-surface p-[clamp(20px,1.67vw,32px)]">
          <p
        ...
        <div className="flex flex-col gap-[clamp(12px,1vw,20px)] text-start">
          <blockquote className="flex flex-col items-start gap-3.5 rounded-card bg-inverse p-[clamp(20px,1.67vw,32px)] text-on-inverse">
          ...
          <div className="flex flex-col items-start gap-2.5 rounded-card bg-surface p-[clamp(20px,1.67vw,32px)]">
